...
parser.add_argument('-m', '--trained_model', default='Resnet18_epoch_40.pth',
                    type=str, help='Trained state_dict file path to open')
parser.add_argument('--network', default='resnet18', help='Backbone network mobile0.25 or resnet50')
parser.add_argument('--origin_size', default=True, type=str, help='Whether use origin image size to evaluate')
parser.add_argument('--save_folder', default='./licenseplate_evaluate/licenseplate_txt/', type=str, help='Dir to save txt results')
...
if __name__ == '__main__':
    ...
    for i, img_name in enumerate(test_dataset):
        ...
        #         line = str(box[0]) + " " + str(box[1]) + " " + str(box[2]) + " " + str(box[3]) + " " + confidence + " \n"
                # fd.write(line)
        ...
        if args.save_image:
            ...
            for b in dets:
                ...
                line = f"{b[5]} {b[6]} {b[7]} {b[8]} {b[9]} {b[10]} {b[11]} {b[12]}"
                print(line)
